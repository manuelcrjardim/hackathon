...
export declare function NeoServerRpcMixin<TBase extends RpcDispatcherMixin>(base: TBase): {
    new (...args: any[]): {
        ...
        url: string;
        execute<TResponse>(query: Query<import("..").JsonRpcParams, TResponse>, config?: import("./RpcDispatcher").RpcConfig): Promise<TResponse>;
        executeAll<TResponses extends unknown[]>(batchQuery: import("..").BatchQuery<import("..").JsonRpcParams[], TResponses>, config?: import("./RpcDispatcher").RpcConfig): Promise<TResponses>;
        executeAll<TResponses extends unknown[]>(batchQuery: Query<import("..").JsonRpcParams, unknown>[], config?: import("./RpcDispatcher").RpcConfig): Promise<TResponses>;
    };
} & TBase;
