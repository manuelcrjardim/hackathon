...
declare const FullRpcClient_base: {
    new (...args: any[]): {
        getNep17Transfers(accountIdentifier: string, startTime?: string, endTime?: string): Promise<import("./Query").GetNep17TransfersResult>;
        getNep17Balances(accountIdentifier: string): Promise<import("./Query").GetNep17BalancesResult>;
        getNep11Transfers(accountIdentifier: string, startTime?: string, endTime?: string): Promise<import("./Query").GetNep11TransfersResult>;
        getNep11Balances(accountIdentifier: string): Promise<import("./Query").GetNep11BalancesResult>;
        url: string;
        execute<TResponse>(query: Query<import("./Query").JsonRpcParams, TResponse>, config?: import("./clients").RpcConfig): Promise<TResponse>;
        executeAll<TResponses extends unknown[]>(batchQuery: import("./BatchQuery").BatchQuery<import("./Query").JsonRpcParams[], TResponses>, config?: import("./clients").RpcConfig): Promise<TResponses>;
        executeAll<TResponses extends unknown[]>(batchQuery: Query<import("./Query").JsonRpcParams, unknown>[], config?: import("./clients").RpcConfig): Promise<TResponses>;
    };
} & {
    new (...args: any[]): {
    ...
    new (...args: any[]): {
        ...
        getBlock(indexOrHash: number | string, verbose: 1 | true): Promise<import("../types").BlockJson>;
        getBlockHash(index: number): Promise<string>;
        getBlockCount(): Promise<number>;
        getBlockHeader(indexOrHash: number | string, verbose?: 0): Promise<string>;
        getBlockHeader(indexOrHash: number | string, verbose: 1): Promise<import("../types").BlockHeaderJson>;
        ...
        getRawMemPool(shouldGetUnverified: 1 | true): Promise<import("./Query").GetRawMemPoolResult>;
        getRawTransaction(txid: string, verbose?: 0 | false): Promise<string>;
        getRawTransaction(txid: string, verbose: 1 | true): Promise<import("./Query").GetRawTransactionResult>;
        ...
        sendRawTransaction(transaction: import("../tx").Transaction | string | import("../u").HexString): Promise<string>;
        ...
        calculateNetworkFee(tx: import("../tx").Transaction | import("../u").HexString | string): Promise<string>;
