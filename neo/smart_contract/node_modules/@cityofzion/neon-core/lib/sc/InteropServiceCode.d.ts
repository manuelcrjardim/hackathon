export declare enum InteropServiceCode {
...
export declare function generateInteropServiceCode(methodName: string): string;
export declare function fromMethodName(methodName: string): InteropServiceCode;
//# sourceMappingURL=InteropServiceCode.d.ts.map